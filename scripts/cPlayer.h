...
*/
//Changes made in DA:
//Added Get_GameObj, Destroy_GameObj, Get_Team, Get_ID
//Added DAPlayerClass
...
public:
	...
	void Set_Wol_ClanID(uint32 wolClanId);
	...
	int Get_Ip_Address() {return IpAddress;}
	...
	const WideStringClass &Get_Name() {return PlayerName;}
	int Get_Player_Type() {return PlayerType;}
	int Get_Rung() {return Rung;}
	...
	bool IsInGame; // 1980
	bool IsActive; // 1981
	//unsigned long WolClanId; // 1984

	//Added by DA
	DAPlayerClass *DAPlayer; //Replaces the unused WolClanId. This allows the functionality added in DAPlayerClass to be used directly through cPlayer.
	inline void Set_DA_Player(DAPlayerClass *Player) {
		DAPlayer = Player;
	}
	inline DAPlayerClass *Get_DA_Player() {
		return DAPlayer;
	}
	inline int Get_ID() const { return PlayerId; }
	inline int Get_Team() const { return PlayerType; }
